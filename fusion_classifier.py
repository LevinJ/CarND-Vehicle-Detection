...
def extract_features(imgs, cspace='RGB', orient=9, 
    ...
    for file in imgs:
        ...
        rhist, ghist, bhist, bin_centers, hist_features = color_hist(feature_image, nbins=32, bins_range=(0, 256))
        # Append the new feature vector to the features list
        features.append(np.hstack((hog_features, hist_features)))
...
#     notcars = notcars[0:sample_size]
    ...
    print("extracting fusion fetures ....")
    t=time.time()
    ...
    notcar_features = extract_features(notcars, cspace=colorspace, orient=orient, 
                            ...
                            hog_channel=hog_channel)
    t2 = time.time()
    print(round(t2-t, 2), 'Seconds to extract fusion features...')
    ...
    model_path = '../data/fusion_smvmodel.pickle'
